      ...
      <div className={styles.wrapper}>
        <div className={styles.to_left}>
          <div className={styles.current_data}>
            ...
            <h3 className={styles.name}>{usersProfileData?.firstName}</h3>
            <p className={styles.number}>{usersProfileData?.phoneNumber}</p>
          </div>
          <div className={styles.tabs}>
            <div className={styles.tab}>
              <BsFillPenFill style={{ marginRight: "10px" }} color="#ff6972" />
        ...
        <div className={styles.to_right}>
          <div className={styles.rename}>
            ...
            <Button width="150px" onClick={() => setDisabled(!disabled)}>
              Редактировать
            </Button>
          </div>
